'''10. Imagine a situação em que existem 2 copos com sucos de
fruta. O primeiro copo está com suco de laranja, enquanto o segundo está com suco de acerola. Você deseja mudar os sucos
...
print("\nAntes")
print(f"copo1 = {copo1} e copo2 = {copo2}")
